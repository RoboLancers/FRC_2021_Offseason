...
public class ShootThreePowerCells extends SequentialCommandGroup {
    public ShootThreePowerCells(Drivetrain drivetrain, Shooter shooter, Intake intake, Odometry odometry, Limelight limelight, Trajectory trajectory) {
        new Ramsete(odometry, drivetrain, trajectory);
