...
public class ShootSixPowerCells extends SequentialCommandGroup {
    public ShootSixPowerCells(Drivetrain drivetrain, Gyro gyro, Loader loader, Shooter shooter, Intake intake, Odometry odometry, Limelight limelight, StartingPosition startingPosition, Trajectories trajectories) {
