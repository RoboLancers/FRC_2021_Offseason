...
public class Odometry {
    ...
    public Odometry(Drivetrain drivetrain, Gyro gyro){
        ...
        wheelSpeeds = null;// new DifferentialDriveWheelSpeeds(this.drivetrain.getLeft().getVelocity(), this.drivetrain.getRight().getVelocity());
    ...
    public DifferentialDriveWheelSpeeds getWheelSpeeds() {
        return null;//new DifferentialDriveWheelSpeeds(this.drivetrain.getLeft().getVelocity(), this.drivetrain.getRight().getVelocity());
    }
