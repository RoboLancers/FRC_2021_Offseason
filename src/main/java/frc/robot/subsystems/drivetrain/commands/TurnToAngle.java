...
//     public static double P = 0.0274;
//     public static double I = 0.00;
//     public static double D = 0.0043;
...
//             ),
//             () -> {
//                 SmartDashboard.putNumber("GYRO", Math.IEEEremainder(gyro.getYaw(), 360));
//                 return Math.IEEEremainder(gyro.getYaw(), 360);
//             },
//             () -> targetAngle,
//             (output, setpoint) -> {
//                 int direction = output.intValue() < 0 ? -1 : 1;
//                 double magnitude = Math.min(Math.max(Math.abs(output.doubleValue()), 0.05), 0.35);
